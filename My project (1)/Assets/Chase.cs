...
public class Chase : MonoBehaviour
{
    ...
    void MoveTowardsPlayer()
    {
        ...
        SubAnimator.SetBool("Moving", true);
        SubAnimator.SetFloat("Horizontal", (targetPlayer.position.x - direction.x)); //Brindar al animator las coordenadas horizontales
        SubAnimator.SetFloat("Vertical", (targetPlayer.position.y - direction.y)); //Brindar al animator las coordenadas verticales
    }
